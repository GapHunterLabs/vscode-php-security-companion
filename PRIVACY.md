# Privacy Policy — PHP Security Companion

**Effective date:** 2026-09-07

PHP Security Companion is a Gap Hunter Labs extension for Visual Studio Code. This
...
**Nothing.** PHP Security Companion does not collect, store, transmit, or sell any
...
**None.** PHP Security Companion makes zero network calls during normal operation.
...
None. PHP Security Companion has no third-party SDKs, no analytics libraries, no
